...
namespace NPOI.OpenXml4Net.OPC
{
    ...
    public class ZipPackagePart : PackagePart
    {
         ...
         *             Throws if the content of this part is invalid.
         */
        internal ZipPackagePart(OPCPackage container, ZipEntry zipEntry,
                    PackagePartName partName, String contentType, bool loadRelationships)
                : base(container, partName, new ContentType(contentType), loadRelationships)
        {
