...
namespace NPOI.XSSF.UserModel
{
    ...
    public class XSSFRangeCopier : RangeCopier
    {

        public XSSFRangeCopier(ISheet sourceSheet, ISheet destSheet)
        ...
        {
            XSSFWorkbook hostWorkbook = (XSSFWorkbook) destSheet.Workbook;
            XSSFEvaluationWorkbook fpb = XSSFEvaluationWorkbook.Create(hostWorkbook);
            Ptg[] ptgs = FormulaParser.Parse(cell.CellFormula, fpb, FormulaType.Cell, 0);
